...
#[doc(inline)]
pub(crate) use __export_bug_impl as export;

#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.24.0:bug:encoded world"]
#[doc(hidden)]
...
A\x02\x01B\x07\x04\0\x06engine\x03\x01\x01i\0\x01@\0\0\x01\x04\0\x13[constructor\
]engine\x01\x02\x01h\0\x01@\x01\x04self\x03\0y\x04\0\x16[method]engine.execute\x01\
\x04\x04\x01\x14vscode:example/types\x05\0\x04\x01\x12vscode:example/bug\x04\0\x0b\
\x09\x01\0\x03bug\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-compone\
